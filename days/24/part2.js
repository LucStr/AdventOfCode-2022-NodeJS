...
function findPath(start, end, steps){
    const visited = new Set();
    const queue = [{tile: start, steps, tail: [start]}];
    let result;
    while(true){
...
const first = findPath(start, end, 0);
const second = findPath(end, start, first);
const result = findPath(start, end, second);
